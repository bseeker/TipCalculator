package edu.galileo.rodrigo.tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTipValues() {
        ...
        tvTipAmount.setText(getString(R.string.main_msg_tiptotal, df.format(tipTotal)));
        tvBillTotalAmount.setText(getString(R.string.main_msg_billtotalresult, df.format(finalBillAmount)));
    }
